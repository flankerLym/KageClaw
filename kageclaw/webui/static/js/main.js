...
function initListeners() {
    ...
    chatInput.addEventListener("keydown", (e) => {
        if (e.key === "Enter" && !e.shiftKey) {
            ...
            try {
                const mobileEnter = localStorage.getItem("kageclaw_mobile_enter_newline") === "true";
...
function initGithubPopup() {
    ...
    if (localStorage.getItem('kageclaw_gh_star_dismissed') === 'true') {
        return;
    }
    ...
    setTimeout(() => {
        ...
        if (popup && dismissBtn && starLink) {
            ...
            const dismissPopup = () => {
                ...
                localStorage.setItem('kageclaw_gh_star_dismissed', 'true');
            };
