...
class MicrophoneInput {
    ...
    hideTranscribing() {
        const input = document.getElementById("chat-input");
        if (input) {
            input.placeholder = this._origPlaceholder || "Send a message to kageClaw...";
...
function initSpeechControls() {
    ...
    const storedTTS = localStorage.getItem("kageclaw_tts_enabled");
    if (storedTTS !== null) {
    ...
    if (ttsToggle) {
        ...
        ttsToggle.addEventListener("change", (e) => {
            ...
            localStorage.setItem("kageclaw_tts_enabled", speechTTS.enabled);
