...
class AgentManager:
    ...
    async def deliver_background_notification(
        ...
        *,
        ...
        from kageclaw.webui.ws_handler import broadcast_notification, deliver_to_browsers
    ...
    async def reset_agent(self):
        ...
        self.load_latest_config()
        from kageclaw.webui.utils import _gateway_request
    ...
    async def archive_via_gateway(self, snapshot: list[dict]):
        ...
        from kageclaw.webui.utils import _gateway_post
