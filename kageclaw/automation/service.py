...
Replaces both CronService (kageclaw/cron/) and HeartbeatService
(kageclaw/heartbeat/).  A single asyncio event-driven timer loop manages
jobs of two kinds:
...
class AutomationService:
    ...
    async def _heartbeat_decide(self, active_tasks: str) -> tuple[str, str]:
        ...
        try:
            from kageclaw.helpers.helpers import current_time_str
