"""Authentication and OAuth provider management for the kageClaw CLI."""
...
def _is_oauth_authenticated(spec) -> bool:
    ...
    if spec.name == "openai_codex":
        codex_path = os.path.join(home, ".config", "kageclaw", "openai_codex", "credentials.json")
    ...
    if spec.name == "github_copilot":
        token_paths = [
            os.path.join(home, ".kageclaw", "github_copilot", "access-token"),
        ]
