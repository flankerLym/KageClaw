...
class ProfileManager:
    ...
    def list_profiles(self) -> list[dict[str, Any]]:
        ...
        entry: dict[str, Any] = {
            ...
            "label": default_meta.get("label", "kageClaw"),
            "description": default_meta.get("description", "The original joyful kage assistant"),
            "builtin": True,
    ...
    def get_profile(self, profile_id: str) -> dict[str, Any] | None:
        ...
        if profile_id == DEFAULT_PROFILE_ID:
            result: dict[str, Any] = {
                "id": DEFAULT_PROFILE_ID,
                "label": meta.get("label", "kageClaw"),
                "description": meta.get("description", "The original joyful kage assistant"),
                "builtin": True,
    ...
    def update_profile(
        ...
        if profile_id == DEFAULT_PROFILE_ID:
            ...
            entry = manifest.get(
                ...
                {
                    "label": "kageClaw",
                    "description": "The original joyful kage assistant",
                    "builtin": True,
                },
            )
