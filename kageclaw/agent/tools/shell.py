...
from kageclaw.security.install_audit import AuditResult, audit_install, detect_install_command
...
class ExecTool(Tool):
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from kageclaw.security.network import contains_internal_url
