...
if TYPE_CHECKING:
    from kageclaw.thinkers.registry import ProviderSpec
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.kageclaw/workspace"
    model: str = ""
    provider: str = (
...
class DesktopConfig(Base):
    ...
    # Register kageClaw to start automatically at Windows login.
...
class Config(BaseSettings):
    """Root configuration for kageclaw."""
    ...
    model_config = SettingsConfigDict(env_prefix="kageCLAW_", env_nested_delimiter="__")
