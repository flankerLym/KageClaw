...
from kageclaw.helpers.helpers import split_message
from kageclaw.integrations.base import BaseChannel
from kageclaw.security.network import validate_url_target
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm kageclaw.\n\n"
    ...
    async def _forward_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        """Forward slash commands to the bus for unified handling in kageBrain."""
        if not update.message or not update.effective_user:
            return
