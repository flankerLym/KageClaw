"""Brain management for conversation history — the memory of the kage."""
...
from kageclaw.config.paths import get_legacy_sessions_dir
from kageclaw.helpers.helpers import ensure_dir, safe_filename
...
class PackManager:
    """
    Manages conversation sessions for the kage pack.
    """
